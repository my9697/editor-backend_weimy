...
export class WorkController {
  ...
  async update(
    ...
    return await this.workService.update(
      id.toString(),
      _id.toString(),
      updateWorkDto,
    );
